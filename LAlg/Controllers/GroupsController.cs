...
namespace LAlg.Controllers
{
    ...
    public class GroupsController : Controller
    {
        ...
        // GET: Groups
        public async Task<IActionResult> Index(string sortOrder, string search)//Guid? id
        {
            //if (id == null)
            //{
            //    return NotFound();
            //}
            var botAppContext = _context.Groups.Include(g => g.Age).Include(g => g.GroupType).Include(g => g.Product);//.Where(g => g.GroupId == id)
