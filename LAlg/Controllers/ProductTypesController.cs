...
namespace LAlg.Controllers
{
    ...
    public class ProductTypesController : Controller
    {
        ...
        public ProductTypesController(BotAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductTypeId,Name,IsActive")] ProductType productType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductTypeId,Name,IsActive")] ProductType productType)
        {
